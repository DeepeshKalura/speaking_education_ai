...
export const Homepage = () => {
  ...
  const backgroundImage = useMotionTemplate`radial-gradient(ellipse at top, #020617 20%, ${color} 100%)`;
  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0 bg-gradient-to-br from-transparent to-black opacity-40 pointer-events-none"></div>
